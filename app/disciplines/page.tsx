  ...
  return (
    <div className="container disciplines-page">
      ...
      <section className="discipline-section">
        <div className="section-heading section-heading--stacked"><p className="hero__eyebrow hero__eyebrow--dark">Choose a field</p><h2>See the experience through a professional’s eyes.</h2><p className="discipline-section__intro">Dentistry is live, and Medicine now has a searchable 10,000-activity catalog. Every discipline connects into the cross-discipline trip experience.</p></div>
