import catalogJson from "@/data/nursing-courses.json";
...
export const nursingCatalogGeneratedAt = catalog.generated_at;
export const nursingCatalogCount = catalog.count;
export const nursingCatalogFacets = {
...
export function searchNursingCourses({ q = "", specialty = "", format = "", date = "", sort = "relevance", page = 1, pageSize = 12 } = {}) {
